...
//test( 'select rows', function() {
//	// @TODO merge with add-row and delete-row tests so we can make this atomic
//	equal(typeof($( '.row .selected')[0]), 'undefined', "Nothing selected to begin with");
//	$( '.add-row' ).trigger( 'click' );
//	$( '.row').trigger( 'click' );
//	equal($( '.row .selected').length, 1, "Added and selected a row");
