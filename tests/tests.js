...
test( "add, select and remove rows", function() {
...
test( 'form html', function() {
	// we really don't need to test this, it's basic jQuery functionality, but it's a useful placeholder for when we do something more clever with the output
